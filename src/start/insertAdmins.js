...
const insertAdmins = async () => {
    //Create Server Admin
    await spRegisterNewUser('Server', 'Admin', 'softshares_15_05_00@yopmail.com', 0);
    ...
    await spRegisterNewUser('Fundao', 'Admin', 'softshares_fundao@yopmail.com', 3);
    await spCreatePassword(19, '123456@Softshares-fundao');
    await spActivateUser(19);
    await spSetCenterAdmin (19, 3);

    await spRegisterNewUser('Portalegre', 'Admin', 'softshares_portalegre@yopmail.com', 4);
    await spCreatePassword(20, '123456@Softshares-portalegre');
    await spActivateUser(20);
    await spSetCenterAdmin (20, 4);

    await spRegisterNewUser('VilaReal', 'Admin', 'softshares_vilareal@yopmail.com', 5);
